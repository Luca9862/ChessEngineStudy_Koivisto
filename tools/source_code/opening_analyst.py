...
def main(filename):
    ...
    if non_zero_data:
        ...
        ax.set_aspect('equal')
        ax.set_title('Grafico risultati')
...
main(r'C:\Users\canal\Documents\GitHub\tirocinio_lucacanali\dataset\game_script_eros\koiv_berserk\1sec\Koivisto_berserk_1sec_fix_exported.pgn')
